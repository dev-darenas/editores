...
class EnterprisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enterprise" do
    assert_difference('Enterprise.count') do
      post enterprises_url, params: { enterprise: { country_id: @enterprise.country_id, description: @enterprise.description, name: @enterprise.name } }
    end
  ...
  test "should update enterprise" do
    patch enterprise_url(@enterprise), params: { enterprise: { country_id: @enterprise.country_id, description: @enterprise.description, name: @enterprise.name } }
